...
('The 4-Hour Body','Timothy Ferriss','Crown Business'),
('The 4-Hour Chef','Timothy Ferriss','Crown Business');
--create a table called borrower with the following fields borrower_id,borrower_name,book_id and set borrower_id as a primary key and set borrower_id as an auto increment add foreign key to book_id
...
--create a table called author with the following fields author_id,author_name,book_id and set author_id as a primary key and set author_id as an auto increment add foreign key to book_id
CREATE TABLE author(
...
('Timothy Ferriss',9),
('Timothy Ferriss',10);
--create a table called publisher with the following fields publisher_id,publisher_name,book_id and set publisher_id as a primary key and set publisher_id as an auto increment, add foreign key to book_id
